...
All images in this directory are sourced from Freepik.com and are used under Freepik's Free License with proper attribution.
...
- **File:** `asian-stirfry-vegetables.jpg`
- **Source URL:** [Add Freepik URL here]
- **License:** Freepik Free License
- **Author:** [Add author name]

- **File:** `mexican-tacos-chicken.jpg`
- **Source URL:** [Add Freepik URL here]
- **License:** Freepik Free License
- **Author:** [Add author name]

- **File:** `american-burger-classic.jpg`
- **Source URL:** [Add Freepik URL here]
- **License:** Freepik Free License
- **Author:** [Add author name]

- **File:** `mediterranean-greek-salad.jpg`
- **Source URL:** [Add Freepik URL here]
- **License:** Freepik Free License
- **Author:** [Add author name]

- **File:** `indian-curry-chicken.jpg`
- **Source URL:** [Add Freepik URL here]
- **License:** Freepik Free License
- **Author:** [Add author name]

- **File:** `french-ratatouille.jpg`
- **Source URL:** [Add Freepik URL here]
- **License:** Freepik Free License
- **Author:** [Add author name]

- **File:** `japanese-sushi-roll.jpg`
- **Source URL:** [Add Freepik URL here]
- **License:** Freepik Free License
- **Author:** [Add author name]

- **File:** `chinese-fried-rice.jpg`
- **Source URL:** [Add Freepik URL here]
- **License:** Freepik Free License
- **Author:** [Add author name]

- **File:** `thai-pad-thai.jpg`
- **Source URL:** [Add Freepik URL here]
- **License:** Freepik Free License
- **Author:** [Add author name]
...
These images are used under Freepik's Free License, which requires attribution.

**License Terms:** https://www.freepik.com/terms-of-use

**Attribution Requirements:**
- Provide credit to Freepik and the image author
- Include a link back to Freepik
- Indicate if changes were made to the images

**Changes Made:**
- Images have been optimized and resized to 1200x800px for web performance
- File format may have been converted for optimal compression

## How to Attribute

When using these images in the application, attribution is provided through:
1. This ATTRIBUTION.md file in the source repository
2. Optional footer credit on recipe pages (if implemented)
3. Credits page at `/about/credits` (if implemented)

## Download Instructions

To download images from Freepik:
1. Visit https://www.freepik.com/
2. Search for food/recipe images
3. Select high-quality images matching the cuisine types
4. Download with proper attribution
5. Optimize to 1200x800px, ~150KB
6. Update this file with source URLs and author information
